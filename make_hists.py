...
def main():
  ...
  HH_Analysis(inputroot,output_name,regions,channel,category)
...
def HH_Analysis(inputfile,outputname,regions,channel,category):
...
#      Filter="zlep_mass>105 && l1_pt>20 && l2_pt>12 && lep_2G0F==1 && mm_channel && !IsSS && nLooseMuon==0 && nLooseElectron==0 && nTightAK4JetCRall>1 && nTightAK4JetCRall_b_DeepJetL>1 && TT_Lb1_pt>0 && TT_Lb2_pt>0 && met_user>50"
  ...
  if regions=="SR2F":
    if channel=='ele':
      Filter="HZ_2F0R && H_AK8Jet_pt>0 && Z_AK8Jet_pt>0 && zlep_mass<105 && lep_2G0F==1 && l1_pt>25 && l2_pt>15 && ee_channel && !IsSS && nLooseMuon==0 && nLooseElectron==0 && zlep_mass>10"
    else:
      Filter="HZ_2F0R && H_AK8Jet_pt>0 && Z_AK8Jet_pt>0 && zlep_mass<105 && lep_2G0F==1 && l1_pt>20 && l2_pt>12 && mm_channel && !IsSS && nLooseMuon==0 && nLooseElectron==0 && zlep_mass>10"
  if regions=="SRHF":
    if channel=='ele':
      Filter="HZ_1F2R && H_AK8Jet_pt>0 && nzhad>0 && zlep_mass<105 && lep_2G0F==1 && l1_pt>25 && l2_pt>15 && ee_channel && !IsSS && nLooseMuon==0 && nLooseElectron==0 && zlep_mass>10"
    else:
      Filter="HZ_1F2R && H_AK8Jet_pt>0 && nzhad>0 && zlep_mass<105 && lep_2G0F==1 && l1_pt>20 && l2_pt>12 && mm_channel && !IsSS && nLooseMuon==0 && nLooseElectron==0 && zlep_mass>10"
  if regions=="SRZF":
    if channel=='ele':
      Filter="HZ_1F2R && Z_AK8Jet_pt>0 && h_j1_pt>0 && h_j2_pt>0 && zlep_mass<105 && lep_2G0F==1 && l1_pt>25 && l2_pt>15 && ee_channel && !IsSS && nLooseMuon==0 && nLooseElectron==0 && zlep_mass>10"
    else:
      Filter="HZ_1F2R && Z_AK8Jet_pt>0 && h_j1_pt>0 && h_j2_pt>0 && zlep_mass<105 && lep_2G0F==1 && l1_pt>20 && l2_pt>12 && mm_channel && !IsSS && nLooseMuon==0 && nLooseElectron==0 && zlep_mass>10"
  if regions=="SR0F":
    if channel=='ele':
      Filter="HZ_0F4R && nzhad>0 && h_j1_pt>0 && h_j2_pt>0 && zlep_mass<105 && lep_2G0F==1 && l1_pt>25 && l2_pt>15 && ee_channel && !IsSS && nLooseMuon==0 && nLooseElectron==0 && zlep_mass>10"
    else:
      Filter="HZ_0F4R && nzhad>0 && h_j1_pt>0 && h_j2_pt>0 && zlep_mass<105 && lep_2G0F==1 && l1_pt>20 && l2_pt>12 && mm_channel && !IsSS && nLooseMuon==0 && nLooseElectron==0 && zlep_mass>10"
  ...
  df_event.Snapshot('Events','slim.root')
